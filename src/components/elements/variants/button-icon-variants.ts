  ...
  "cursor-pointer relative inline-flex items-center justify-center gap-1 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300",
  {
    variants: {
      ...
      shadow: {
        ...
        purple:
          "hover:enabled:shadow-xl hover:enabled:shadow-purple-500/50 dark:hover:enabled:shadow-purple-800/20",
      },
    },
    ...
    compoundVariants: [
...

      {
        ...
        variant: "solid",
        className:
          "[&>span>.loader]:text-muted-100 border border-purple-500 bg-purple-500 text-white enabled:hover:bg-purple-600 active:enabled:bg-purple-400",
      },
      {
        color: "purple",
        variant: "pastel",
        className:
          "[&>span>.loader]:text-purple-500 bg-purple-500/10 dark:bg-purple-500/20 text-purple-500 enabled:hover:bg-purple-500/20 dark:enabled:hover:bg-purple-500/30 active:enabled:bg-purple-500/10 dark:active:enabled:bg-purple-500/10",
      },
      {
        color: "purple",
        variant: "outlined",
        className:
          "[&>span>.loader]:text-purple-500 border border-purple-500 text-purple-500 hover:bg-purple-500 active:enabled:bg-purple-400 hover:text-white",
      },
    ],
